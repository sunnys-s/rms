...
class NominationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nomination" do
    assert_difference('Nomination.count') do
      post nominations_url, params: { nomination: { award_id: @nomination.award_id, nomination_type: @nomination.nomination_type } }
    end
  ...
  test "should update nomination" do
    patch nomination_url(@nomination), params: { nomination: { award_id: @nomination.award_id, nomination_type: @nomination.nomination_type } }
