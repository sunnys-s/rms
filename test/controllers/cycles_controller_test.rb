...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { end_date: @cycle.end_date, start_date: @cycle.start_date, status: @cycle.status, title: @cycle.title } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { end_date: @cycle.end_date, start_date: @cycle.start_date, status: @cycle.status, title: @cycle.title } }
